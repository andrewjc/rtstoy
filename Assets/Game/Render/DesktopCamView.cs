...
public class DesktopCamView : MonoBehaviour {
	...
	// Public fields
        ...
        public void Start()
        {
            ...
            doubleClickDetector = gameObject.AddComponent<DoubleClickDetector>();
...
//			transform.SetLocalEulerAngles(0.0f, null, null);
            ...
            transform.localEulerAngles = new Vector3(oldXRotation, transform.localEulerAngles.y, transform.localEulerAngles.z);
        }
        ...
        private void UpdatePosition()
        {
            ...
            if (adaptToTerrainHeight && terrain != null)
            {
                transform.position = new Vector3(
                    ...
                    Mathf.Max(terrain.SampleHeight(transform.position) + terrain.transform.position.y + cameraHeight, transform.position.y),
